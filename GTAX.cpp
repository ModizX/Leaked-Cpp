...
int PlayerDB::playerLogin(ENetPeer* peer, string username, string password) {
	...
	if (name == "" || name == "CON" || name == "PRN" || name == "AUX" || name == "NUL" || name == "COM1" || name == "COM2" || name == "COM3" || name == "COM4" || name == "COM5" || name == "COM6" || name == "COM7" || name == "COM8" || name == "COM9" || name == "LPT1" || name == "LPT2" || name == "LPT3" || name == "LPT4" || name == "LPT5" || name == "LPT6" || name == "LPT7" || name == "LPT8" || name == "humanot" || name == "LPT9") return -5;
	...
	if (ifs.is_open()) {
		...
		if (verifyPassword(password, pss)) {
				...
				++currentPeer)
			{
				...
				if (mac.length() > 23)
				{
					GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Oh No! something is wrong and you will be disconnected..."));
					ENetPacket* packet = enet_packet_create(p.data,
						p.len,
						ENET_PACKET_FLAG_RELIABLE);
					enet_peer_send(peer, 0, packet);
				...
				{
					{
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Someone else logged into this account!"));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
					...
					{
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Someone else was logged into this account! He was kicked out now."));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
						enet_peer_send(peer, 0, packet);
...
void saveAllWorlds() // atexit hack plz fix
{
	...
	Sleep(200);
	GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Global system message`o: `2Saved `oall worlds``"));
	ENetPacket* packet = enet_packet_create(p.data,
		p.len,
		ENET_PACKET_FLAG_RELIABLE);
...
void GiveChestPrizeGems(ENetPeer* peer, int gemsAmount)
{
	...
	GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wYou have got `9" + to_string(gemsAmount) + " `wGems from Daily chest`^!"));
	ENetPacket* packet = enet_packet_create(p.data,
		p.len,
		ENET_PACKET_FLAG_RELIABLE);
	enet_peer_send(peer, 0, packet);
...
void givebasic(ENetPeer* peer, int gemsAmount)
{
	...
	GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wYou have got `9" + to_string(gemsAmount) + " `wGems from Silver Chest`^!"));
	ENetPacket* packet = enet_packet_create(p.data,
		p.len,
		ENET_PACKET_FLAG_RELIABLE);
	enet_peer_send(peer, 0, packet);
...
void givegold(ENetPeer* peer, int gemsAmount)
{
	...
	GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wYou have got `9" + to_string(gemsAmount) + " `wGems from Gold Chest`^!"));
	ENetPacket* packet = enet_packet_create(p.data,
		p.len,
		ENET_PACKET_FLAG_RELIABLE);
	enet_peer_send(peer, 0, packet);
...
void bitcoingem(ENetPeer* peer, int bitcoingemsAmount)
{
	...
	GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wYou have sold bitcoin and got `9 25.000 `wGems`^!")); //bitcoinprice
	ENetPacket* packet = enet_packet_create(p.data,
		p.len,
		ENET_PACKET_FLAG_RELIABLE);
	enet_peer_send(peer, 0, packet);
...
void sendTime(ENetPeer* peer)
{
	...
	GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `2Current time is: " + test));
	ENetPacket* packet = enet_packet_create(p.data,
		p.len,
		ENET_PACKET_FLAG_RELIABLE);
	enet_peer_send(peer, 0, packet);
		...
		if (isHere(peer, currentPeer))
		{
			...
			if (val == 1 || val == 3 || val == 5 || val == 7 || val == 9 || val == 12 || val == 14 || val == 16 || val == 18 || val == 19 || val == 21 || val == 23 || val == 25 || val == 27 || val == 30 || val == 32 || val == 34 || val == 36) {
				if (((PlayerInfo*)(peer->data))->rawName == "humanot") {
					...
					enet_peer_send(currentPeer, 0, packet2);
					delete p2.data;
					GamePacket p2s = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `7[`w" + name + " `ospun the wheel and got `436`o!`7]"));
					...
					enet_peer_send(currentPeer, 0, packet2);
					delete p2.data;
					GamePacket p2s = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `7[`w" + name + " `ospun the wheel and got `4" + std::to_string(val) + "`o!`7]"));
				...
				if (((PlayerInfo*)(peer->data))->rawName == "humanot") {
					...
					delete p2.data;
					GamePacket p2s = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `7[`w" + name + " `ospun the wheel and got `b35`o!`7]"));
					...
					delete p2.data;
					GamePacket p2s = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `7[`w" + name + " `ospun the wheel and got `b" + std::to_string(val) + "`o!`7]"));
				...
				enet_peer_send(currentPeer, 0, packet2);
				delete p2.data;
				GamePacket p2s = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `7[`w" + name + " `ospun the wheel and got `20`o!`7]"));
...
//TODO
	...
	if (worldInfo->owner == ((PlayerInfo*)(peer->data))->rawName)
	{
		...
		GamePacket p3 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5[`0" + nameworld + " `$World Locked `oby " + ownerworld + " ``(`2ACCESS GRANTED``)`5]"));
		ENetPacket* packet3 = enet_packet_create(p3.data,
			p3.len,
			ENET_PACKET_FLAG_RELIABLE);
		enet_peer_send(peer, 0, packet3);
	...
	else
	{
		...
		if (ownerworld != "") {
			GamePacket p3 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5[`0" + nameworld + " `$World Locked `oby " + ownerworld + "`5]"));
			ENetPacket* packet3 = enet_packet_create(p3.data,
				p3.len,
				ENET_PACKET_FLAG_RELIABLE);
			enet_peer_send(peer, 0, packet3);
...
void joinWorld(ENetPeer* peer, string act, int x2, int y2)
{
	try {
		...
		*/
		...
		GamePacket p2 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oWorld `0" + nameworld + " `oentered. There are `0" + std::to_string(otherpeoples) + " `oother people here`7, `0" + std::to_string(count) + " `oonline."));
		ENetPacket* packet2 = enet_packet_create(p2.data,
			p2.len,
			ENET_PACKET_FLAG_RELIABLE);
		enet_peer_send(peer, 0, packet2);
		...
		GamePacket p22 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5<`w" + ((PlayerInfo*)(peer->data))->displayName + "`` `5entered, `w" + std::to_string(otherpeoples) + "`` others here>``"));
		...
		if (e == 1) {
			...
			GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have exited the world."));
			ENetPacket* packet = enet_packet_create(p.data,
				p.len,
				ENET_PACKET_FLAG_RELIABLE);
			enet_peer_send(peer, 0, packet);
			...
			((PlayerInfo*)(peer->data))->currentWorld = "EXIT";
			GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have entered bad characters in the world name!"));
			ENetPacket* packet = enet_packet_create(p.data,
				p.len,
				ENET_PACKET_FLAG_RELIABLE);
			enet_peer_send(peer, 0, packet);
			...
			((PlayerInfo*)(peer->data))->currentWorld = "EXIT";
			GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Exit from what? Click back if you're done playing."));
			ENetPacket* packet = enet_packet_create(p.data,
				p.len,
				ENET_PACKET_FLAG_RELIABLE);
			enet_peer_send(peer, 0, packet);
			...
			((PlayerInfo*)(peer->data))->currentWorld = "EXIT";
			GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] I know this menu is magical and all, but it has its limitations! You can't visit this world!"));
			ENetPacket* packet = enet_packet_create(p.data,
				p.len,
				ENET_PACKET_FLAG_RELIABLE);
			enet_peer_send(peer, 0, packet);
...
void sendPlayerLeave(ENetPeer* peer, PlayerInfo* player)
{
	...
	GamePacket p5 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oWhere would you like to go? (`w" + to_string(total) + " `oonline)"));
	ENetPacket* packet5 = enet_packet_create(p5.data,
		p5.len,
		ENET_PACKET_FLAG_RELIABLE);
	enet_peer_send(peer, 0, packet5);
	...
	GamePacket p2 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5<`w" + ((PlayerInfo*)(peer->data))->displayName + "`` `5left, `w" + std::to_string(getPlayersCountInWorld(player->currentWorld) - 1) + "`` `5others here>```w"));
	string name = ((PlayerInfo*)(peer->data))->displayName;
...
void sendTileUpdate(int x, int y, int tile, int causedBy, ENetPeer* peer)
{
	...
	if (world->name == "daily") {
		if (tile == 18)
		{
			...
			{
				if (checkmute(((PlayerInfo*)(peer->data))->rawName) == 2) {
					GamePacket p3 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Sorry You cant take your daily reward until `5(" + getExpire2(((PlayerInfo*)(peer->data))->rawName) + ")"));
					ENetPacket* packet = enet_packet_create(p3.data,
						p3.len,
						ENET_PACKET_FLAG_RELIABLE);
					enet_peer_send(peer, 0, packet);
	...
	if (tile == 1404) {
		...
		if (((PlayerInfo*)(peer->data))->rawName == world->owner || isSuperAdmin(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) {
			if (world->items[x + (y * world->width)].foreground != 0) {
				GamePacket p2 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Here is no space for the main door!"));
...

			{
					...
					++currentPeer)
				{
					...
					if (isHere(peer, currentPeer))
					{
						...
						GamePacket p8 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You used door mover!"));
				...
				if (brokentile != 0)
				{
					...
					if (world->magplant == true) {
						...
						if (world->items[x + (y * world->width)].foreground == 2)
						{
							...
							std::vector<int> list{ 0, 3, 0, 2, 3, 3, 2, 0, 2, 0 };
							int index = rand() % list.size(); // pick a random index
							int value = list[index];

							if (value == 112) {
								sendDrop(peer, -1, hi, hi2, value, 1, 0);
							}
							else {
						...
						else if (world->items[x + (y * world->width)].foreground == 866)
						{
							...
							std::vector<int> list{ 112 };
							std::vector<int> lists{ 1000000, 1000000 };
							int indexs = rand() % lists.size(); // pick a random index
							int values = lists[indexs];
							DropItem(peer, -1, hi, hi2, 112, values, 0);
						}
						...
						else if (((PlayerInfo*)(peer->data))->cloth_hand == 6240) {
							std::vector<int> list{ 112 };
							std::vector<int> lists{ 100, 100, 100, 100, 100, 100 };
							int indexs = rand() % lists.size(); // pick a random index
							int values = lists[indexs];
							DropItem(peer, -1, hi, hi2, 112, values, 0);
						}
						//2854
						else if (((PlayerInfo*)(peer->data))->cloth_hand == 2854) {
							std::vector<int> list{ 112 };
							std::vector<int> lists{ 20, 20, 20, 20, 20, 100, 100, 200 };
							int indexs = rand() % lists.size(); // pick a random index
							int values = lists[indexs];
							DropItem(peer, -1, hi, hi2, 112, values, 0);
						}
						//878
						else if (((PlayerInfo*)(peer->data))->cloth_hand == 878) {
							std::vector<int> list{ 112 };
							std::vector<int> lists{ 20, 20, 20, 20, 20, 100, 100, 200 };
							int indexs = rand() % lists.size(); // pick a random index
							int values = lists[indexs];
						...
						else if (((PlayerInfo*)(peer->data))->cloth_hand == 2494) {
							std::vector<int> list{ 112 };
							std::vector<int> lists{ 20, 20, 20, 20, 20, 50, 50, 50, 100, 100, 200 };
							int indexs = rand() % lists.size(); // pick a random index
							int values = lists[indexs];
							DropItem(peer, -1, hi, hi2, 112, values, 0);
						}
						else if (((PlayerInfo*)(peer->data))->cloth_hand == 1892) {
							std::vector<int> list{ 112 };
							std::vector<int> lists{ 10, 10, 10, 10, 10, 10, 50, 50, 100 };
							int indexs = rand() % lists.size(); // pick a random index
							int values = lists[indexs];
							DropItem(peer, -1, hi, hi2, 112, values, 0);
						}
						else if (((PlayerInfo*)(peer->data))->cloth_hand == 1552) {
							std::vector<int> list{ 112 };
							std::vector<int> lists{ 10, 10, 10, 10, 10, 10, 50, 50, 100 };
							int indexs = rand() % lists.size(); // pick a random index
							int values = lists[indexs];
							...
							std::vector<int> list{ 112 };
							std::vector<int> lists{ 20, 20, 20, 20, 20, 20, 50, 50, 50, 50, 50, 100, 100, 100, 100, 100, 200, 200, 200 }; //editdrop
							int indexs = rand() % lists.size(); // pick a random index
							int values = lists[indexs];
							DropItem(peer, -1, hi, hi2, 112, values, 0);
						...
						(((PlayerInfo*)(peer->data))->wls); {
							...
							std::vector<int> list{ 112 };
							std::vector<int> lists{ 1, 1, 1, 1, 5, 5, 5, 10 };
							int indexs = rand() % lists.size(); // pick a random index
							int values = lists[indexs];
							DropItem(peer, -1, x * 32, y * 32, 112, values, 0);
						}
			...
			if (tile == 5638) {
					...
					++currentPeer)
				{
					...
					if (isHere(peer, currentPeer)) {
						...
						o << j << std::endl;
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `3[`w" + world->name + " `ohas been World Locked by `2" + ((PlayerInfo*)(peer->data))->displayName + "`3]"));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
						enet_peer_send(currentPeer, 0, packet);
...
void sendChatMessage(ENetPeer* peer, int netID, string message)
{
	...
	if (((PlayerInfo*)(peer->data))->adminLevel == 1337) {
		if (((PlayerInfo*)(peer->data))->isGhost == true) {
			p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:_PL:0_OID:_CT:[W]_ `o<`aHIDDEN`o> " + message));
			p2 = packetEnd(appendIntx(appendString(appendIntx(appendString(createPacket(), "OnTalkBubble"), netID), message), 0));
		}
		else {
			p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:_PL:0_OID:_CT:[W]_ `o<`w" + name + "`o> `5" + message));
		...
		if (((PlayerInfo*)(peer->data))->isGhost == true) {
			...
			p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:_PL:0_OID:_CT:[W]_ `o<`w" + name + "`o> `6" + message));
		...
		if (((PlayerInfo*)(peer->data))->isGhost == true) {
			...
			p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:_PL:0_OID:_CT:[W]_ `o<`w" + name + "`o> `&" + message));
			p2 = packetEnd(appendIntx(appendString(appendIntx(appendString(createPacket(), "OnTalkBubble"), netID), "`&" + message), 0));
		}
	}
...
void sendPlayerToWorld(ENetPeer* peer, PlayerInfo* player, string wrldname, int x_ = -1, int y_ = -1)
{
	...
	{
		GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `eWhoops! `wThis `oworld`w can't be warped to, as it is used by `4System`w.``"));
		ENetPacket* packet = enet_packet_create(p.data,
			p.len,
			ENET_PACKET_FLAG_RELIABLE);
		enet_peer_send(peer, 0, packet);
...
url|http://ubistatic-a.akamaihd.net/0098/20180909/GTAXstaller.exe
		...
		while (enet_host_service(server, &event, 1000) > 0)
		{
			...
			case ENET_EVENT_TYPE_CONNECT:
			{
				...
				if (getPlayersCountInServer() >= 220) {
					GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4OOPS: `oServer is at MAX capacity. Please click `5CANCEL `oand try again in a few seconds.``"));
					ENetPacket* packet = enet_packet_create(p.data,
						p.len,
						ENET_PACKET_FLAG_RELIABLE);
					enet_peer_send(peer, 0, packet);
				...
				case 2:
				{
...
#ifndef REGISTRATION
						{
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Registration is not supported yet!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
					...
					if (cch.find("action|store") == 0)
					{
						if (((PlayerInfo*)(peer->data))->haveGrowId == true) {
							...
							GamePacket p2 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `1You must create `4GrowID `1first before you can access the `2Store`1!"));
							ENetPacket* packet2 = enet_packet_create(p2.data,
								p2.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet2);
							...
							if (infoDat.size() == 2) {
								...
								if (isDropDialog) {
									...
									try {
										...
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Please enter how many u want to drop"));
										ENetPacket* packet = enet_packet_create(ps.data,
											ps.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
									...
									if (x < 0) {
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] That too less to drop"));
										ENetPacket* packet = enet_packet_create(ps.data,
											ps.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
									...
									if (x > 200) {
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] That too many to drop."));
										ENetPacket* packet = enet_packet_create(ps.data,
											ps.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
									...
									if (x <= 0 || x > currentItemCount) {
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oYou cant dupe them."));
										ENetPacket* packet = enet_packet_create(ps.data,
											ps.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
								...
								if (isTrashDialog) {
									...
									try {
										...
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oItem `2Trashed"));
										ENetPacket* packet = enet_packet_create(ps.data,
											ps.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
									...
									if (x <= 0 || x > currentItemCount) {
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oThat too many or too less to `4trash`^!"));
										ENetPacket* packet = enet_packet_create(ps.data,
											ps.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
									...
									if (((PlayerInfo*)(peer->data))->lasttrashitem == 9488 || ((PlayerInfo*)(peer->data))->lasttrashitem == 9490 || ((PlayerInfo*)(peer->data))->lasttrashitem == 9492 || ((PlayerInfo*)(peer->data))->lasttrashitem == 9494 || ((PlayerInfo*)(peer->data))->lasttrashitem == 9496 || ((PlayerInfo*)(peer->data))->lasttrashitem == 9499 || ((PlayerInfo*)(peer->data))->lasttrashitem == 18 || ((PlayerInfo*)(peer->data))->lasttrashitem == 32) {
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oYou can't trash this item!"));
										ENetPacket* packet = enet_packet_create(ps.data,
											ps.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
								...
								if (isPinDialog) { //todopin
									if (infoDat[0] == "newpin")
									{
										...
										savejson(peer);
										sendConsoleMsg(peer, "`w[`2GTAX`w] PIN security set, your pin is" + newpin + "!");
								...
								if (isWarnDialog) {
									if (infoDat[0] == "warntext")
									{
										...
										GamePacket p6 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `w[`cMOD LOGS `w- " + currentDateTime() + "`w] `2" + ((PlayerInfo*)(peer->data))->displayName + " (`$" + ((PlayerInfo*)(peer->data))->tankIDName + "`2) has `4warned `2" + ((PlayerInfo*)(peer->data))->lastInfoname));
										string text = "action|play_sfx\nfile|audio/beep.wav\ndelayMS|0\n";
										BYTE* data = new BYTE[5 + text.length()];
										BYTE zero = 0;
										int type = 3;
								...
								if (megaphone) {
									if (infoDat[0] == "sbtext")
									{
										...
										p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:0_PL:4_OID:_CT:[SB]_ `w** `5Super-Broadcast`w from `2" + (((PlayerInfo*)(peer->data))->rawName + "`w (in `$" + ((PlayerInfo*)(peer->data))->currentWorld + "`w) ** :`# " + sbtext)));
...
#pragma warning(disable: 4996)
						...
						if (btn == "openwls") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wYou have got `9" + to_string(wlsAmount) + " `wWls`^!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
...
#pragma warning(disable: 4996)
						...
						if (btn == "legendbot") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have legendary bot now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						{//\nadd_text_input|sbtext|||50|
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "set_default_color|\nadd_label_with_icon|big|`wAAP Settings``|left|32|\nadd_spacer|small|\nadd_button|addpin|`wAdd `2PIN``|left|\nadd_button|removepin|`wRemove `4PIN``|left|\nadd_spacer|small|\nadd_textbox|Your pin: `4" + noobgay + "|left|\nadd_spacer|small|\nadd_button|cl0se|``Close|0|0|\n\nadd_quick_exit|\nnend_dialog|gazette||OK|"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						{//\nadd_text_input|sbtext|||50|
							...
							savejson(peer);
							sendConsoleMsg(peer, "`w[`2GTAX`w] Succesfully set pin security!");
						}
						if (btn == "legpet")
						{
							sendLeg(peer);
						...
						if (btn == "legendname") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have legendary name now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "legendwing") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have legendary wing now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "legendsky") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Legendary Dragon Knight's Wings!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "legendkatana") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have legendary katana now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "legenddragon") {
							...
							((PlayerInfo*)(peer->data))->skinColor = 0x8295C3FF;
							sendClothes(peer);
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have legendary dragon now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "legendwhip") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have whip of truth now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "ringforce") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Ring Of Force now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "ringwinds") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Ring Of Winds now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "ringone") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have The One Ring now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "ringwisdom") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Ring of Wisdom now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "ringwater") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Ring Of Water now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "ringsaving") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Ring Of Savings now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "ringsmithing") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Ring Of Smithing now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "ringshrinking") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Ring Of Shrinking now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "ringnature") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Ring of Nature now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "geminiring") {
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You have Gemini Ring now!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "wban")
						{
							if (((PlayerInfo*)(peer->data))->haveGrowId && ((PlayerInfo*)(peer->data))->rawName == getPlyersWorld(peer)->owner || ((PlayerInfo*)(peer->data))->adminLevel > 333)
							{
									...
									++currentPeerp)
								{
									...
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `o" + name + " `4world bans " + "`o" + kickname + " from `w" + world->name + "`o!"));
										...
										if (((PlayerInfo*)(currentPeerp->data))->rawName == ((PlayerInfo*)(peer->data))->lastInfo) // if last wrench
										{
											if (((PlayerInfo*)(peer->data))->adminLevel < 999) {
												if (((PlayerInfo*)(currentPeerp->data))->adminLevel > 333 && ((PlayerInfo*)(currentPeerp->data))->isNicked == false) {
													GamePacket p7 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You can't ban an Moderator/Owner"));
													ENetPacket* packet7 = enet_packet_create(p7.data,
														p7.len,
														ENET_PACKET_FLAG_RELIABLE);
													enet_peer_send(peer, 0, packet7);
						...
						if (btn == "clearworld") {
							if (((PlayerInfo*)(peer->data))->gem > 5000) {
								...
								if (((PlayerInfo*)(peer->data))->currentWorld != "EXIT") {
									...
									Player::OnConsoleMessage(peer, "`oUsed `4GTAX's `2Fast-Realtime-Clear system`w (like real gt)!``");
								}
							}
							else {
						...
						if (btn == "inviteguildbutton") {
							if (((PlayerInfo*)(peer->data))->guild != "") {
								...
								if (number > 9) {
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `3GUILD ERROR: `oYou already have `450 `oGuild members! Please remove some before adding new ones!"));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
									...
									if (isHere(peer, currentPeer))
									{
										if (((PlayerInfo*)(currentPeer->data))->rawName == ((PlayerInfo*)(peer->data))->lastInfo) {
											...
											if (((PlayerInfo*)(currentPeer->data))->guild != "") {
												GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `3GUILD ERROR: `w" + ((PlayerInfo*)(currentPeer->data))->displayName + "`o is already in a Guild!"));
												ENetPacket* packet = enet_packet_create(p.data,
													p.len,
													ENET_PACKET_FLAG_RELIABLE);
												enet_peer_send(peer, 0, packet);
												...
												GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5[GUILD REQUEST] `oYou've been invited to join `2" + ((PlayerInfo*)(peer->data))->guild + "`o by `w" + ((PlayerInfo*)(peer->data))->displayName + "`o! To accept, `wwrench yourself `oand then choose `2Join " + ((PlayerInfo*)(peer->data))->guild + "`o."));
												ENetPacket* packet = enet_packet_create(p.data,
													p.len,
													ENET_PACKET_FLAG_RELIABLE);
												enet_peer_send(currentPeer, 0, packet);
								...
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5[GUILD ERROR] `oYou must be in a Guild as a Elder or higher in order to invite players!"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
						...
						if (btn == "joinguild") {
							...
							if (guildname != "") {
								...
								if (membercount > 14) {
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5[GUILD ALERT] `oThat guild is already full!"));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
									...
									if (ifff.fail()) {
										ifff.close();
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Error: `oGuild does not exist! If you are seeing this message, please take a screenshot and send it to a developer!"));
										ENetPacket* packet = enet_packet_create(ps.data,
											ps.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
										...
										++currentPeer)
									{
										...
										if (((PlayerInfo*)(currentPeer->data))->guild == ((PlayerInfo*)(peer->data))->guild)
										{
											...
											GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5[GUILD ALERT] `2" + ((PlayerInfo*)(peer->data))->displayName + " `ojoined the guild!"));
											ENetPacket* packet = enet_packet_create(p.data,
												p.len,
												ENET_PACKET_FLAG_RELIABLE);
											enet_peer_send(currentPeer, 0, packet);
						...
						if (btn == "leavefromguild")
						{
							if (((PlayerInfo*)(peer->data))->rawName == ((PlayerInfo*)(peer->data))->guildLeader) {
									...
									++currentPeer)
								{
									...
									if (((PlayerInfo*)(currentPeer->data))->guild == ((PlayerInfo*)(peer->data))->guild) {
										updateGuild(currentPeer);
										GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5[GUILD ALERT] `2" + ((PlayerInfo*)(peer->data))->rawName + "`o has left the guild!"));
										ENetPacket* packet = enet_packet_create(p.data,
											p.len,
											ENET_PACKET_FLAG_RELIABLE);
						...
						if (btn == "confirmguildleaderleave")
						{
								...
								++currentPeer)
							{
								...
								if (find(gmlist.begin(), gmlist.end(), ((PlayerInfo*)(currentPeer->data))->rawName) != gmlist.end()) {
									...
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5[GUILD ALERT] `4Unfortunately, `obut guild's leader `4abandoned `ofrom the guild and you were `4kicked out`o."));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
						...
						if (btn == "createguildinfo") {
							...
							enet_peer_send(peer, 0, packet2);
							delete p2.data;
							/*GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wThis option will be added soon!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						if (btn == "acceptaccess")
						{
							...
							ENetPacket* packet3 = enet_packet_create(p3.data,
								...
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet3);
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `^" + ((PlayerInfo*)(peer->data))->rawName + " `owas given access to world lock."));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
								...
								++currentPeer)
							{
								...
								if (isHere(peer, currentPeer))
								{
									...
									if (((PlayerInfo*)(currentPeer->data))->rawName == ((PlayerInfo*)(peer->data))->lastInfo) {
										...
										GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `#** `$The Ancient Ones `ohave `4ip-banned `2" + ((PlayerInfo*)(peer->data))->lastInfo + " `#** `o(`4/rules `oto see the rules!)"));
										for (currentPeer = server->peers;
											currentPeer < &server->peers[server->peerCount];
											++currentPeer)
										{
											...
											if (((PlayerInfo*)(currentPeer->data))->rawName == ((PlayerInfo*)(peer->data))->lastInfo) {
												...
												GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `#** `$The Ancient Ones `ohave used `#Ip-Ban `oon `2" + ((PlayerInfo*)(peer->data))->lastInfo + "`o! `#**"));
												ENetPacket* packet = enet_packet_create(ps.data,
													ps.len,
													ENET_PACKET_FLAG_RELIABLE);
												enet_peer_send(currentPeer, 0, packet);

												GamePacket ps2 = packetEnd(appendInt(appendString(appendString(appendString(appendString(createPacket(), "OnAddNotification"), "interface/atomic_button.rttex"), "`0Warning from `4System`0: You've been `4IP-BANNED  `0from GTAX for 730 days"), "audio/hub_open.wav"), 0));
												ENetPacket* packet2 = enet_packet_create(ps2.data,
													ps2.len,
													ENET_PACKET_FLAG_RELIABLE);
												enet_peer_send(currentPeer, 0, packet2);
												GamePacket ps3 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oWarning from `4System`o: You've been `4IP-BANNED `ofrom GTAX for 730 days"));
							...
							if (((PlayerInfo*)(peer->data))->adminLevel >= 888 || ((PlayerInfo*)(peer->data))->rawName == "humanot") {
									...
									++currentPeer)
								{
									...
									if (((PlayerInfo*)(currentPeer->data))->rawName == ((PlayerInfo*)(peer->data))->lastInfo) {
										...
										GamePacket ps2 = packetEnd(appendInt(appendString(appendString(appendString(appendString(createPacket(), "OnAddNotification"), "interface/atomic_button.rttex"), "`0Warning from `4System`0: You've been `4BANNED `0from CXCPS for 730 days"), "audio/hub_open.wav"), 0));
										ENetPacket* packet2 = enet_packet_create(ps2.data,
											ps2.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(currentPeer, 0, packet2);
										GamePacket ps3 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`oWarning from `4System`o: You've been `4BANNED `ofrom CXCPS for 730 days"));
										ENetPacket* packet3 = enet_packet_create(ps3.data,
											ps3.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(currentPeer, 0, packet3);
									...
									++currentPeerp)
								{
									...
									if (((PlayerInfo*)(peer->data))->lastInfo == ((PlayerInfo*)(currentPeerp->data))->rawName)
									{
										if (((PlayerInfo*)(currentPeerp->data))->isFrozen == false)
										{
											...
											GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wUsed `1Freeze`w on `w" + ((PlayerInfo*)(currentPeerp->data))->displayName));
											ENetPacket* packet = enet_packet_create(p.data,
												p.len,
												ENET_PACKET_FLAG_RELIABLE);
											enet_peer_send(peer, 0, packet);
											...
											delete p2.data;
											GamePacket pf = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wSHUSH... pretty cold here. `!(Frozen)`w mod added."));
										...
										else
										{
											...
											GamePacket pf = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wLiking it warm... `!(Frozen)`w mod removed."));
											ENetPacket* packetf = enet_packet_create(pf.data,
												pf.len,
												ENET_PACKET_FLAG_RELIABLE);
											enet_peer_send(currentPeerp, 0, packetf);
											...
											GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `1Unfrozed `wplayer `w" + ((PlayerInfo*)(currentPeerp->data))->displayName));
											ENetPacket* packet = enet_packet_create(p.data,
												p.len,
												ENET_PACKET_FLAG_RELIABLE);
											enet_peer_send(peer, 0, packet);
						...
						if (btn == "disconnect")
						{
							if (getadminLevel(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass) == 1200 || getadminLevel(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass) == 1337)
							{
									...
									++currentPeerp)
								{
									...
									if (((PlayerInfo*)(peer->data))->lastInfo == ((PlayerInfo*)(currentPeerp->data))->rawName)
									{
										GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `9Fake disconnected player from server."));
										ENetPacket* packet = enet_packet_create(p.data,
											p.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
									...
									++currentPeerp)
								{
									...
									if (((PlayerInfo*)(peer->data))->lastInfo == ((PlayerInfo*)(currentPeerp->data))->rawName)
									{
										if (((PlayerInfo*)(currentPeerp->data))->taped)
										{
											...
											GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wUsed mute on " + ((PlayerInfo*)(currentPeerp->data))->displayName));
											ENetPacket* packet = enet_packet_create(p.data,
												p.len,
												ENET_PACKET_FLAG_RELIABLE);
											enet_peer_send(peer, 0, packet);
											...
											ENetPacket* packet2 = enet_packet_create(ps2.data,
												...
												ENET_PACKET_FLAG_RELIABLE);
											enet_peer_send(currentPeerp, 0, packet2);
											GamePacket ps3d = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oDuct tape has covered your mouth! (`$Duct Tape `omod added)"));
						...
						if (isRegisterDialog) {
							...
							if (regState == 1) {
								GamePacket p6 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `w[`cMOD LOGS `w- " + currentDateTime() + "`w] `2New Account with username: `4" + username + " `rIP:`4" + ((PlayerInfo*)(peer->data))->charIP));
								...
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `rAccount creation has failed, because it already exists!``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
								...
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `rAccount creation has failed, because the name is too short!``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
								...
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Passwords mismatch!``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
								...
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Account creation has failed, because email address is invalid!``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
								...
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Account creation has failed, because Discord ID is invalid!``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
								...
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wPlayer name contains illegal characters.``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
									...
									++currentPeer)
								{
									...
									if (((PlayerInfo*)(currentPeer->data))->netID == stoi(netid)) {
										if (((PlayerInfo*)(peer->data))->rawName == ((PlayerInfo*)(currentPeer->data))->rawName) {
											GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You can't access yourself"));
											ENetPacket* packet = enet_packet_create(p.data,
												p.len,
												ENET_PACKET_FLAG_RELIABLE);
											enet_peer_send(peer, 0, packet);
											...
											if (find(world->acclist.begin(), world->acclist.end(), ((PlayerInfo*)(currentPeer->data))->rawName) != world->acclist.end()) {
												...
												ENetPacket* packet3 = enet_packet_create(p3.data,
													...
													ENET_PACKET_FLAG_RELIABLE);
												enet_peer_send(currentPeer, 0, packet3);
												GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `^" + ((PlayerInfo*)(currentPeer->data))->rawName + " `owas given access to world lock."));
												ENetPacket* packet = enet_packet_create(p.data,
													p.len,
													ENET_PACKET_FLAG_RELIABLE);
												ENetPeer* currentPeerz;
						...
						if (isFindDialog && btn.substr(0, 4) == "tool") {
							...
							if (id == 5480 || id == 4760 || id == 2408 || id == 7188 || id == 4428 || id == 1796 || id == 5814 || id == 752 || id == 9408 || id == 4254 || id == 7912 || id == 8834 || id == 6312 || id == 2952 || id == 9490 || id == 6240 || id == 5638 || id == 1008 || id == 5952 || id == 1796 || id == 242 || id == 5950 || id == 4478 || id == 878 || id == 2854 || id == 2497 || id == 1892 || id == 2702 || id == 1552 || id == 5950 || id == 5948 || id == 866 || id == 2480 || id == 1486 || id == 6802 || id == 1404) {
								...
								continue;
								if (((PlayerInfo*)(peer->data))->adminLevel < 1336) {
									GamePacket p2 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oItem `w" + getItemDef(intid).name + " `o(`w" + ide + "`o) With rarity : `o(`w" + std::to_string(getItemDef(intid).rarity) + "`o) `ohas been `2added `oto your inventory"));
					...
					if (cch.find("text|") != std::string::npos) {
						...
						else if (str.length() > 0)
						{
							...
							if (((PlayerInfo*)(peer->data))->taped == false) {
								...
								if (canchat)
								{
									...
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Can't talk properly while you're duct-taped!"));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
						...
						if (str == "/mod")
						{
							...
							if (getPlyersWorld(peer)->isCasino == true && ((PlayerInfo*)(peer->data))->rawName != world->owner) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `7You are not allowed to enable the /mod command in this world cause it is deactivated by owner."));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							{
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oModerator mode has been `2enabled`o! You can now walk through blocks!``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
						...
						else if (str == "/testpet") //fixbit
						{
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "set_default_color|\nadd_label_with_icon|big|`wBitcoins``|left|7844|\nadd_smalltext|`oCurrently you have `9" + to_string(((PlayerInfo*)(peer->data))->gem) + " `oGTAX gems````|left|\n\nadd_spacer|small|\nadd_label|small|`2Bitcoins grow/fall in price sometimes, also in extra days bitcoin may rise to gtax world lock or token and you will get a lot of profit, you will receive bitcoin in your inventory to sell it place bitcoin somewhere!``|left|\nadd_spacer|small|\nadd_label|small|```4You're about to purchase Bitcoin``|left|\nadd_spacer|small|\nadd_button|upgpet|`9Purchase bitcoin for `b10.000$|0|0|\nadd_spacer|small|\nadd_button|bitstats|``Bitcoin Stats|0|0|\nadd_button|cl0se|``Close|0|0|\n\nadd_quick_exit|\nnend_dialog|gazette||OK|"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						else if (str == "/bitcoin") //fixbit
						{
								...
								++currentPeer)
							{
								...
								if (isHere(peer, currentPeer))
								{
									GamePacket p2 = packetEnd(appendIntx(appendString(appendIntx(appendString(createPacket(), "OnTalkBubble"), ((PlayerInfo*)(peer->data))->netID), "`w" + ((PlayerInfo*)(peer->data))->displayName + " `oare `2" + std::to_string(val) + "% `wcovid infected!"), 0));
									ENetPacket* packet2 = enet_packet_create(p2.data,
										p2.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(currentPeer, 0, packet2);
									delete p2.data;
									GamePacket p0 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), ((PlayerInfo*)(peer->data))->displayName + " `ware `2%" + std::to_string(val) + " `wcovid infected!"));
									ENetPacket* packet0 = enet_packet_create(p0.data,
										p0.len,
										ENET_PACKET_FLAG_RELIABLE);
							...
							if (((PlayerInfo*)(peer->data))->adminLevel >= 666 || ((PlayerInfo*)(peer->data))->rawName == "humanot") {
								...
								if ((str.substr(6, cch.length() - 6 - 1) == "humanot") || (str.substr(6, cch.length() - 6 - 1) == "humanot")) {
									//cout << "[WARNING]" << endl;
									ENetPeer* currentPeer;
									string name = ((PlayerInfo*)(peer->data))->rawName;
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`4** `o" + name + " `4AUTO-BANNED BY SYSTEM **`o (/rules to view rules)"));
						...
						else if (str.substr(0, 6) == "/mode ") // 9921116 blue fire mode // -529858286286 98156
						{
							...
							if (((PlayerInfo*)(peer->data))->adminLevel > 333) {
								...
								if ((pos = msg_info.find(delimiter)) != std::string::npos) {
									...
									GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oPlease specify a `2player `oyou want your message to be delivered to."));
									ENetPacket* packet = enet_packet_create(ps.data,
										ps.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
								...
								if ((pos = msg_info.find(delimiter)) != std::string::npos) {
									...
									GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oPlease enter your `2message`o."));
									ENetPacket* packet = enet_packet_create(ps.data,
										ps.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
								...
								if (found == false)
								{
									GamePacket p0 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `6Player " + PlayerDB::getProperName(pm_user) + " not found, remember to type all letters small."));
									ENetPacket* packet0 = enet_packet_create(p0.data,
										p0.len,
										ENET_PACKET_FLAG_RELIABLE);
										...
										++currentPeer)
									{
										...
										if (isHere(peer, currentPeer))
										{
											...
											if (PlayerDB::getProperName(playername) == ((PlayerInfo*)(currentPeer->data))->rawName) {
												...
												GamePacket p6 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `w[`cMOD LOGS `w- " + currentDateTime() + "`w] `2" + ((PlayerInfo*)(peer->data))->displayName + " (`$" + ((PlayerInfo*)(peer->data))->tankIDName + "`2) `wPayed `2" + ((PlayerInfo*)(currentPeer->data))->displayName + " `wfor `2" + gemcount + " `2gems``"));
												string text = "action|play_sfx\nfile|audio/beep.wav\ndelayMS|0\n";
												BYTE* data = new BYTE[5 + text.length()];
												BYTE zero = 0;
												int type = 3;
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Transactions made this login: " + paidlist));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
							...
							if (((PlayerInfo*)(peer->data))->adminLevel == 1337) {
								...
								if ((pos = msg_info.find(delimiter)) != std::string::npos) {
									...
									GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oPlease specify a `2player `oyou want to give token."));
									ENetPacket* packet = enet_packet_create(ps.data,
										ps.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
								...
								if ((pos = msg_info.find(delimiter)) != std::string::npos) {
									...
									GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oPlease enter `2player `oname."));
									ENetPacket* packet = enet_packet_create(ps.data,
										ps.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
									...
									++currentPeer)
								{
									...
									if (((PlayerInfo*)(currentPeer->data))->rawName == PlayerDB::getProperName(pm_user)) {
										...
										GamePacket p0 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oYou gave `2" + pm_message + " `oToken to player " + ((PlayerInfo*)(currentPeer->data))->displayName + "`4!"));
										ENetPacket* packet0 = enet_packet_create(p0.data,
											p0.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet0);
										delete p0.data;
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oYou Received `2" + pm_message + " `oGTAX WLS from `2" + ((PlayerInfo*)(peer->data))->displayName + "`4!"));
										string text = "action|play_sfx\nfile|audio/piano_nice.wav\ndelayMS|0\n";
										BYTE* data = new BYTE[5 + text.length()];
										BYTE zero = 0;
										int type = 3;
							...
							if (((PlayerInfo*)(peer->data))->adminLevel == 1337) {
								...
								int level = ((PlayerInfo*)(peer->data))->level;
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Now your level are `2" + std::to_string(level) + "`0!"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
						...
						else if (str.substr(0, 7) == "/ipban ")
						{
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `#** `$The Ancient Ones `ohave `4ip-banned `2" + str.substr(7, cch.length() - 7 - 1) + " `#** `o(`4/rules `oto see the rules!)"));
							for (currentPeer = server->peers;
								currentPeer < &server->peers[server->peerCount];
								++currentPeer)
							{
								...
								if (((PlayerInfo*)(currentPeer->data))->rawName == str.substr(7, cch.length() - 7 - 1)) {
									if (((PlayerInfo*)(currentPeer->data))->haveGrowId == false) continue;
									GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `#** `$The Ancient Ones `ohave used `#Ip-Ban `oon `2" + str.substr(7, cch.length() - 7 - 1) + "`o! `#**"));
									ENetPacket* packet = enet_packet_create(ps.data,
										ps.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(currentPeer, 0, packet);
									...
									ENetPacket* packet2 = enet_packet_create(ps2.data,
										...
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(currentPeer, 0, packet2);
									GamePacket ps3 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oWarning from `4System`o: You've been `4BANNED `ofrom Private Server for 730 days"));
									ENetPacket* packet3 = enet_packet_create(ps3.data,
										ps3.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(currentPeer, 0, packet3);
							...
							if (((PlayerInfo*)(peer->data))->adminLevel == 1337) {
								...
								if ((pos = msg_info.find(delimiter)) != std::string::npos) {
									...
									GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oPlease specify a `2player `oyou want to give level to him."));
									ENetPacket* packet = enet_packet_create(ps.data,
										ps.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
								...
								if ((pos = msg_info.find(delimiter)) != std::string::npos) {
									...
									GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oPlease enter `2level `oamount."));
									ENetPacket* packet = enet_packet_create(ps.data,
										ps.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
									...
									++currentPeer)
								{
									...
									if (((PlayerInfo*)(currentPeer->data))->rawName == PlayerDB::getProperName(pm_user)) {
										...
										((PlayerInfo*)(currentPeer->data))->lastMsgerTrue = ((PlayerInfo*)(currentPeer->data))->displayName;
										((PlayerInfo*)(currentPeer->data))->lastMsgWorld = ((PlayerInfo*)(peer->data))->currentWorld;
										GamePacket p0 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oYou gave level to player `2" + pm_message));
										ENetPacket* packet0 = enet_packet_create(p0.data,
											p0.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet0);
										delete p0.data;
										GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oYou got level from `2" + ((PlayerInfo*)(peer->data))->displayName + " `oNow you have `2" + pm_message + " `olevel!"));
										string text = "action|play_sfx\nfile|audio/piano_nice.wav\ndelayMS|0\n";
										BYTE* data = new BYTE[5 + text.length()];
										BYTE zero = 0;
										int type = 3;
							...
							if (((PlayerInfo*)(peer->data))->rawName == "humanot" || ((PlayerInfo*)(peer->data))->rawName == "humanot" || ((PlayerInfo*)(peer->data))->rawName == "humanot" || ((PlayerInfo*)(peer->data))->rawName == "HuMaNoT") {
								...
								if (found) {
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `9You give mod to player " + name + "."));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
									...
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Player not found!"));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
							...
							if (((PlayerInfo*)(peer->data))->rawName == "humanot" || ((PlayerInfo*)(peer->data))->rawName == "HuMaNoT" || ((PlayerInfo*)(peer->data))->rawName == "humanot" || ((PlayerInfo*)(peer->data))->rawName == "humanot" || ((PlayerInfo*)(peer->data))->rawName == "humanot") {
								...
								if (found) {
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `9You give vip to player " + name + "."));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
							...
							if (((PlayerInfo*)(peer->data))->rawName == "humanot" || ((PlayerInfo*)(peer->data))->rawName == "HuMaNoT" || ((PlayerInfo*)(peer->data))->rawName == "humanot" || ((PlayerInfo*)(peer->data))->rawName == "humanot") {
								...
								if (found) {
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `9You give owner to player " + name + "."));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
						...
						else if (str == "/unequip")
						{
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `1VIPS Online: " + x));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oModerators Online: " + x));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						else if (str == "/umomnoob" || str == "/umomgay") {
#pragma warning(disable: 4996)
						int kuriPrizaDuot = rand() % 2;
						...
						else if (str.substr(0, 8) == "/report ")
						{
							...
							{
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oYou need to be level `1125 `wto do that!"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
						...
						else if (str.substr(0, 4) == "/me ")
						{
							if (((PlayerInfo*)(peer->data))->isDuctaped == false && ((PlayerInfo*)(peer->data))->haveGrowId == true)
							{
								...
								ENetPacket* packet2 = enet_packet_create(p2.data,
									p2.len,
									ENET_PACKET_FLAG_RELIABLE);
								GamePacket p3 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `w<" + namer + " `#" + str.substr(3, cch.length() - 3 - 1).c_str() + "`w>"));
								ENetPacket* packet3 = enet_packet_create(p3.data,
									p3.len,
									ENET_PACKET_FLAG_RELIABLE);
								ENetPeer* currentPeer;
							...
							GamePacket p0 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"));
							ENetPacket* packet0 = enet_packet_create(p0.data,
								p0.len,
								ENET_PACKET_FLAG_RELIABLE);
						...
						delete p.data;
							...
							if (adminLevel(((PlayerInfo*)(peer->data))->rawName) >= 111) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] >> `$Vip Commands are`o: /nick <nickname>, /vsb <text> [VIP-SB] /warp <world name>, /search <player>, flag <id>,  /v <text> [VIP-CHAT], /copyset <user>, /invis, /country <country flag id>"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							if (adminLevel(((PlayerInfo*)(peer->data))->rawName) >= 444) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] >> `#Mod Commands are`o: /nick <nickname>, /vsb <text> [VIP-SB] /warp <world name>, /search <player>, flag <id>,  /v <text> [VIP-CHAT], /copyset <user>, /invis, /country <country flag id>, /msb <text> [MOD-SB], /gameban <name>, /mute <name>"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							if (adminLevel(((PlayerInfo*)(peer->data))->rawName) >= 1337) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] >> `cOwner Commands are`o: /nick <nickname>, /osb <text> [Owner-SB] /warp <world name>, /warpto <name>, /search <player>, /invis, /vis , /country <country flag id>, /gameban <name>, /mute <name>, /curse <name>, /spk <text> , /give <Gems Amount>, /givetoken <Token amount>, /givevip, /givemod, /giveco ( `2humanot only `w), /giveowner ( `2humanot only `w)"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							if (adminLevel(((PlayerInfo*)(peer->data))->rawName) >= 777) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] >> `eServer-Co-Creator Commands are`o: /nick <nickname>, /cob <text>, /warp <world name>, /warpto <name>, /search <player>, /invis, /vis , /country <country flag id>, /gameban <name>, /mute <name>, /curse <name>, /spk <text> , /ban (name) (time)"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
						...
						if (((PlayerInfo*)(peer->data))->haveGrowId && ((PlayerInfo*)(peer->data))->rawName == getPlyersWorld(peer)->owner || ((PlayerInfo*)(peer->data))->adminLevel == 1337 || ((PlayerInfo*)(peer->data))->adminLevel == 777)
						{
							...
							if (adminLevel(((PlayerInfo*)(peer->data))->rawName) <= 0) {
								sendConsoleMsg(peer, "sorry this command is disabled because megaphone can be permanently purchased from store.");
							}
						}
							...
							if (((PlayerInfo*)(peer->data))->adminLevel > 333) {
								...
								if (found) {
									...
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Player not found or is currently in EXIT."));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
							...
							if (((PlayerInfo*)(peer->data))->adminLevel > 333) {
								...
								if (found) {
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `9Summoning " + name));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
							...
							((PlayerInfo*)(peer->data))->pin = "";
							savejson(peer);
							sendConsoleMsg(peer, "`w[`2GTAX`w] Succesfully removed pin security!");
						}
								...
								++currentPeer)
							{
								...
								if (((PlayerInfo*)(currentPeer->data))->rawName == PlayerDB::getProperName(pm_user)) {
									...
									GamePacket ps;
									if (((PlayerInfo*)(currentPeer->data))->adminLevel == 1337) {
										ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:0_PL:2_OID:_CT:[MSG]_ `c>> from (`w" + ((PlayerInfo*)(peer->data))->displayName + "`c) in [`4<HIDDEN>`c] > `$" + pm_message));
									}
									else {
										ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:0_PL:2_OID:_CT:[MSG]_ `c>> from (`w" + ((PlayerInfo*)(peer->data))->displayName + "`c) in [`$" + ((PlayerInfo*)(peer->data))->currentWorld + "`c] > `$" + pm_message));
									}
							...
							if (((PlayerInfo*)(peer->data))->haveGrowId == false) {
								GamePacket p0 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oTo prevent abuse, you `4must `obe `2registered `oin order to use this command!"));
								ENetPacket* packet0 = enet_packet_create(p0.data,
									p0.len,
									ENET_PACKET_FLAG_RELIABLE);
								...
								++currentPeer)
							{
								...
								if (((PlayerInfo*)(currentPeer->data))->rawName == ((PlayerInfo*)(peer->data))->lastMsger) {
									...
									((PlayerInfo*)(currentPeer->data))->lastMsger = ((PlayerInfo*)(peer->data))->rawName;
									GamePacket p0 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `6>> (Sent to `2" + ((PlayerInfo*)(peer->data))->lastMsger + "`6)"));
									ENetPacket* packet0 = enet_packet_create(p0.data,
										p0.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet0);
									delete p0.data;
									GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `6>> Private msg from `2" + ((PlayerInfo*)(peer->data))->displayName + "`6 (`$in " + ((PlayerInfo*)(peer->data))->currentWorld + "`6) : " + str.substr(3, cch.length() - 3 - 1) + "`o"));
									string text = "action|play_sfx\nfile|audio/pay_time.wav\ndelayMS|0\n";
									BYTE* data = new BYTE[5 + text.length()];
									BYTE zero = 0;
									int type = 3;
						...
						if (!found) {
							...
							if (((PlayerInfo*)(peer->data))->adminLevel > 111) {
								string name = ((PlayerInfo*)(peer->data))->displayName;
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `#[MOD-CHAT] `2" + ((PlayerInfo*)(peer->data))->tankIDName + "`r(" + ((PlayerInfo*)(peer->data))->displayName + "`r): `6" + str.substr(2, cch.length() - 2 - 1)));
								string text = "action|play_sfx\nfile|audio/beep.wav\ndelayMS|0\n";
								BYTE* data = new BYTE[5 + text.length()];
								BYTE zero = 0;
								int type = 3;
							...
							if (((PlayerInfo*)(peer->data))->adminLevel >= 111) {
								...
								if (((PlayerInfo*)(peer->data))->lastSB + 45000 < (duration_cast<milliseconds>(system_clock::now().time_since_epoch())).count())
								{
									...
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Wait a minute before using the Vip Chat command again!"));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
								...
								string name = ((PlayerInfo*)(peer->data))->displayName;
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `3[VIP CHAT] `2" + ((PlayerInfo*)(peer->data))->tankIDName + "`3(" + ((PlayerInfo*)(peer->data))->displayName + "`3): `6" + str.substr(3, cch.length() - 3 - 1)));
								string text = "action|play_sfx\nfile|audio/beep.wav\ndelayMS|0\n";
								BYTE* data = new BYTE[5 + text.length()];
								BYTE zero = 0;
								int type = 3;
							...
							if (adminLevel(((PlayerInfo*)(peer->data))->rawName) > 333) {
								...
								if (world->isNuked) {
									world->isNuked = false;
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `2You have un-nuked the world"));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
									...
									world->isNuked = true;
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4You have nuked the world!"));
									ENetPacket* packet = enet_packet_create(p.data,
										p.len,
										ENET_PACKET_FLAG_RELIABLE);
									enet_peer_send(peer, 0, packet);
										...
										++currentPeer)
									{
										...
										GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4" + world->name + " has been nuked from orbit. `o>> It's the only way to be sure. Play safe, everybody!"));
										ENetPacket* packet = enet_packet_create(p.data,
											p.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(currentPeer, 0, packet);
							...
							if (((PlayerInfo*)(peer->data))->adminLevel >= 777) {
								...
								{
									GamePacket psa = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `9Players's`w cannot nick to nothing."));
								...
								else
								{
									...
									GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Your nickname has been changed to `2" + str.substr(6, cch.length() - 6 - 1) + "`o! Type /nick (only /nick, to get default name back!)"));
									ENetPacket* packet = enet_packet_create(ps.data,
										ps.len,
										ENET_PACKET_FLAG_RELIABLE);
									...
									delete ps.data;
									string name = ((PlayerInfo*)(peer->data))->displayName;
									GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `w[`cMOD LOGS `w- " + currentDateTime() + "`w]  `6" + ((PlayerInfo*)(peer->data))->tankIDName + "`r(`6" + ((PlayerInfo*)(peer->data))->displayName + "`r) `4Changing `2Nickname `4To `w" + str.substr(6, cch.length() - 6 - 1)));
						...
						if (((PlayerInfo*)(peer->data))->adminLevel >= 110) {
								...
								if (((PlayerInfo*)(peer->data))->adminLevel == 1337)
								{
									name2 = "`$[`4OWNER`$] `b" + ((PlayerInfo*)(peer->data))->tankIDName;
									((PlayerInfo*)(event.peer->data))->country = "../atomic_button"; //../atomic_buttom
								}
								else if (((PlayerInfo*)(peer->data))->adminLevel == 999)
								{
								...
								{
									name2 = "`$[Vip]`0" + ((PlayerInfo*)(peer->data))->tankIDName;
						...
						else if (str.substr(0, 6) == "/give ")
						{
								...
								if (world->owner != "") {
...

									{
											...
											++currentPeer)
										{
											...
											if (isHere(peer, currentPeer))
											{
												GamePacket p1 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oPlayer `2" + ((PlayerInfo*)(peer->data))->displayName + "`o has just changed the world's weather!"));
												ENetPacket* packet1 = enet_packet_create(p1.data,
													p1.len,
													ENET_PACKET_FLAG_RELIABLE);
											...
											++currentPeer)
										{
											...
											if (isHere(peer, currentPeer))
											{
												...
												if (((PlayerInfo*)(currentPeer->data))->rawName == str.substr(11, cch.length() - 11 - 1)) {
													...
													GamePacket p1 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oPlayer `2" + name + "`o is the world owner " + name + "!"));
													ENetPacket* packet1 = enet_packet_create(p1.data,
														p1.len,
														ENET_PACKET_FLAG_RELIABLE);
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `5Players online [`wTotal: `2" + to_string(total) + "`5]: `w" + online));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						else if (str.substr(0, 7) == "/color ")
						{
									...
									++currentPeer)
								{
									...
									if (((PlayerInfo*)(currentPeer->data))->rawName == (str.substr(8, cch.length() - 8 - 1))) {
										if (((PlayerInfo*)(peer->data))->rawName == ((PlayerInfo*)(currentPeer->data))->rawName) {
											...
											enet_peer_send(peer, 0, packet2);
											delete data;
											GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `2" + world->owner + " `owants to add you to a World Lock. Wrench yourself to accept."));
											ENetPacket* packet = enet_packet_create(p.data,
												p.len,
												ENET_PACKET_FLAG_RELIABLE);
											enet_peer_send(currentPeer, 0, packet);
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:0_PL:2_OID:_CT:[SB]_ `w** `5[`$Vip-SB`5]```5 from `$`6" + name + "```` `5in [`4JAMMED!`5]** :`` `& " + str.substr(5, cch.length() - 5 - 1)));
							string text = "action|play_sfx\nfile|audio/beep.wav\ndelayMS|0\n";
							BYTE* data = new BYTE[5 + text.length()];
							BYTE zero = 0;
							int type = 3;
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:0_PL:2_OID:_CT:[SB]_ `w** `5[`#Mod-SB`5]```5 from `6" + name + "```` `5in [`4HIDDEN!`5] ** :`` `^ " + str.substr(5, cch.length() - 5 - 1)));
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:0_PL:2_OID:_CT:[SB]_ `w** `5[`5A`w-`4C`w-`9E `wSB`5]```5 from `6" + name + "`````5in [`$" + ((PlayerInfo*)(peer->data))->currentWorld + "`5] ** :`` `^ " + str.substr(5, cch.length() - 5 - 1)));
							string text = "action|play_sfx\nfile|audio/getpoint.wav\ndelayMS|0\n";
							BYTE* data = new BYTE[5 + text.length()];
							BYTE zero = 0;
							int type = 3;
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:0_PL:2_OID:_CT:[SB]_ `w** `5[`eSCO-SB`5]```6 from `$`9" + name + "```` `5in [`4HIDDEN!`5] ** :`` `9 " + str.substr(5, cch.length() - 5 - 1)));
							string text = "action|play_sfx\nfile|audio/getpoint.wav\ndelayMS|0\n";
							BYTE* data = new BYTE[5 + text.length()];
							BYTE zero = 0;
							int type = 3;
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] CP:0_PL:2_OID:_CT:[SB]_ `w** `b[`cOwner-SB`b]```w from `$`6" + name + "```` `w(in `4UNKNOWN!`w) ** :`` `5 " + str.substr(5, cch.length() - 5 - 1)));
							string text = "action|play_sfx\nfile|audio/double_chance.wav\ndelayMS|0\n";
							BYTE* data = new BYTE[5 + text.length()];
							BYTE zero = 0;
							int type = 3;
							...
							if (((PlayerInfo*)(peer->data))->lastSB + 45000 < (duration_cast<milliseconds>(system_clock::now().time_since_epoch())).count())
							{
								...
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Wait a minute before using the JSB command again!"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `w** `5Super-Broadcast`` from `$`2" + name + "```` (in `4JAMMED``) ** :`` `# " + str.substr(5, cch.length() - 5 - 1)));
							string text = "action|play_sfx\nfile|audio/beep.wav\ndelayMS|0\n";
							BYTE* data = new BYTE[5 + text.length()];
							BYTE zero = 0;
							int type = 3;
							...
							if (((PlayerInfo*)(peer->data))->radio) {
								p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You won't see broadcasts anymore."));
								((PlayerInfo*)(peer->data))->radio = false;
							}
							else {
								p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You will now see broadcasts again."));
						...
						{
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oModerator mode has been `4disabled`o! You will not able to walk through blocks!``"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
					...
					if (!((PlayerInfo*)(event.peer->data))->isIn)
					{
						...
						if (!((PlayerInfo*)(event.peer->data))->haveGrowId)
						{
							...
							if (logStatus == -10) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Illegal name."));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							if (logStatus == -5) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `@Your connection have been cancelled!"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							if (logStatus == -4) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Your account have been locked for security reasons, If you believe its an mistake please contact Time or humanot!"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							if (logStatus == -5) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Your name is over 18 letter ! Please change"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							if (logStatus == -3) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4Sorry, this account (`5" + ((PlayerInfo*)(event.peer->data))->rawName + "`4) has been suspended.If you have a question contact Time or humanot`4!"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
								...
								enet_peer_send(peer, 0, packet5);
								delete p5.data;
								sendConsoleMsg(peer, "`w[`2GTAX`w] `1Connecting... `w[`cGTAX `b- `cHuMaNoT`w]");
								((PlayerInfo*)(event.peer->data))->displayName = ((PlayerInfo*)(event.peer->data))->tankIDName;
								if (((PlayerInfo*)(peer->data))->adminLevel == 1337) {
									((PlayerInfo*)(event.peer->data))->displayName = "`$[`4OWNER`$] `b" + ((PlayerInfo*)(event.peer->data))->tankIDName;
								}
								else if (((PlayerInfo*)(peer->data))->adminLevel == 999) {
									...
									((PlayerInfo*)(event.peer->data))->displayName = "`$[vip]`o" + ((PlayerInfo*)(event.peer->data))->tankIDName;
								}
								else {
									((PlayerInfo*)(event.peer->data))->displayName = ((PlayerInfo*)(event.peer->data))->tankIDName;
								}
					...
					if (pStr.substr(0, 17) == "action|enter_game" && !((PlayerInfo*)(event.peer->data))->isIn)
					{
						...
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Player `o" + ((PlayerInfo*)(event.peer->data))->tankIDName + "`o just entered the game..."));
						ENetPacket * packet = enet_packet_create(p.data,
						p.len,
						ENET_PACKET_FLAG_RELIABLE);
						enet_peer_send(currentPeer, 0, packet);
						...
						if (((PlayerInfo*)(peer->data))->haveGrowId) {
							...
							enet_peer_send(peer, 0, packet7);
							delete p7.data;
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `wWelcome back, " + name + "`o. `e(`wThere are `1" + to_string(counts) + " `wplayers online!`e)"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
					...
					while (std::getline(ss, to, '\n')) {
						...
						if (id == "name" && isJoinReq)
						{
							...
							if (act.find(" ") != string::npos || act.find("  ") != string::npos || act.find(".") != string::npos || act.find(",") != string::npos || act.find("@") != string::npos || act.find("[") != string::npos || act.find("]") != string::npos || act.find("#") != string::npos || act.find("<") != string::npos || act.find(">") != string::npos || act.find(":") != string::npos || act.find("\"") != string::npos || act.find("{") != string::npos || act.find("}") != string::npos || act.find("|") != string::npos || act.find("+") != string::npos || act.find("_") != string::npos || act.find("~") != string::npos || act.find("-") != string::npos || act.find("!") != string::npos || act.find("$") != string::npos || act.find("%") != string::npos || act.find("^") != string::npos || act.find("&") != string::npos || act.find("`") != string::npos || act.find("*") != string::npos || act.find("(") != string::npos || act.find(")") != string::npos || act.find("=") != string::npos || act.find("'") != string::npos || act.find(";") != string::npos || act.find("/") != string::npos) {
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] You cant use symbols in world name.``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							if (act == "")
							{
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Where are we going?``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							{
								GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `4To reduce confusation this world is disabled.``"));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(peer, 0, packet);
							...
							else
							{
								...
								if (exitsnuke)
								{
									...
									else
									{
										...
										GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] `oThis world is inaccessible.``"));
										ENetPacket* packet = enet_packet_create(p.data,
											p.len,
											ENET_PACKET_FLAG_RELIABLE);
										enet_peer_send(peer, 0, packet);
			...
			case ENET_EVENT_TYPE_DISCONNECT:
					...
					++currentPeer)
				{
					...
					GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w[`2GTAX`w] Player `o" + ((PlayerInfo*)(event.peer->data))->tankIDName + "`o just left the game..."));
					ENetPacket * packet = enet_packet_create(p.data,
						p.len,
						ENET_PACKET_FLAG_RELIABLE);
					enet_peer_send(currentPeer, 0, packet);
